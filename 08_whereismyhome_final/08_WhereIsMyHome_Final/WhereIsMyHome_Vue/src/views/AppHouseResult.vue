              ...
              >
                <card class="border-0" hover shadow body-classes="py-5">
                  ...
                  <b-modal v-model="modalShow" title="저축하면 얼마나 걸릴까?"
                    ...
                    <hr />
                    {{ getPrice(house.recentPrice) }} * (1-LTV(0.7)) =
                    {{ getPrice2(house.recentPrice) }}<br />
                    {{ getPrice2(house.recentPrice) }} / 100만원 =
                    {{ getPrice3(house.recentPrice) }}
                    <hr />
